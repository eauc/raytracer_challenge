...
* Creation
  ...
  (defprotocol Shape
    ...
    (normal [sh world-p hit] "Computes the normal of the shape at world point"))
  #+END_SRC
...
* Normal
  ...
  #+NAME: shapes_normal
  #+BEGIN_SRC clojure
  (defn normal' [shape world-point hit local-normal-fn]
    (let [local-point (world->object shape world-point)
          local-normal (local-normal-fn shape local-point hit)]
