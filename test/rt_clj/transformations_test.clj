...
(deftest transformations-test
  (testing "Multiplying a point by a translation matrix"
    (is (t/eq? (t/point 2. 1. 7.)
               (m/mul-t (translation 5. -3. 2.) (t/point -3. 4. 5.)))))

  (testing "Multiplying a point by the inverse of a translation matrix"
    (is (t/eq? (t/point -8. 7. 3.)
               (m/mul-t (m/inverse (translation 5. -3. 2.)) (t/point -3. 4. 5.)))))

  (testing "Translation does not affect vectors"
    (is (t/eq? (t/vector 1. 2. 3.)
               (m/mul-t (translation 5. -3. 2.) (t/vector 1. 2. 3.)))))

  (testing "A scaling matrix applied to a point"
    (is (t/eq? (t/point -8. 18. 32.)
               (m/mul-t (scaling 2. 3. 4.)
                        (t/point -4. 6. 8.)))))

  (testing "A scaling matrix applied to a vector"
    (is (t/eq? (t/vector -8. 18. 32.)
               (m/mul-t (scaling 2. 3. 4.)
                        (t/vector -4. 6. 8.)))))
  ...
  (testing "Shearing transformation moves x in proportion to y"
    (is (t/eq? (t/point 5. 3. 4.)
               (m/mul-t (shearing 1. 0. 0. 0. 0. 0.) (t/point 2. 3. 4.)))))

  (testing "Shearing transformation moves x in proportion to z"
    (is (t/eq? (t/point 6. 3. 4.)
               (m/mul-t (shearing 0. 1. 0. 0. 0. 0.) (t/point 2. 3. 4.)))))

  (testing "Shearing transformation moves y in proportion to x"
    (is (t/eq? (t/point 2. 5. 4.)
               (m/mul-t (shearing 0. 0. 1. 0. 0. 0.) (t/point 2. 3. 4.)))))

  (testing "Shearing transformation moves y in proportion to z"
    (is (t/eq? (t/point 2. 7. 4.)
               (m/mul-t (shearing 0. 0. 0. 1. 0. 0.) (t/point 2. 3. 4.)))))

  (testing "Shearing transformation moves z in proportion to x"
    (is (t/eq? (t/point 2. 3. 6.)
               (m/mul-t (shearing 0. 0. 0. 0. 1. 0.) (t/point 2. 3. 4.)))))

  (testing "Shearing transformation moves z in proportion to y"
    (is (t/eq? (t/point 2. 3. 7.)
               (m/mul-t (shearing 0. 0. 0. 0. 0. 1.) (t/point 2. 3. 4.)))))
  ...
  (testing "Individual transformations are applied in sequence"
    (let [p (t/point 1. 0. 1.)
      ...
      (is (t/eq? (t/point 5. -5. 0.)
                 (m/mul-t s (m/mul-t r p))))
      (is (t/eq? (t/point 15. 0. 7.)
                 (m/mul-t t (m/mul-t s (m/mul-t r p)))))))
